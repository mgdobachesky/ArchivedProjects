<%@ Page Title="" Language="C#" MasterPageFile="~/resturant.Master" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="se256_Dobachesky.signup" %>
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <legend>Sign-Up</legend>
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnAdd" runat="server" Text="Sign-Up"
            ...
            <div class="col-sm-8">
                ...
                <asp:ValidationSummary ID="vsSignUpForm" runat="server"  />
            </div>
        </div>
    </div> 
</asp:Content>
