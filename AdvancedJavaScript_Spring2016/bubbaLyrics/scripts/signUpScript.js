(function() {
	htmlString = "<li><a href='http://ict.neit.edu/001264912/public_html/se251/bubbaLyrics/index.php'>Home</a></li><li class='active'>Sign Up</li>";
			...
			$('#signUpForm').on('submit', function(event){
				...
				if(valPassword == valRePassword && valEmail == valReEmail){
					if(valEmail != "" && valPassword != ""){
						$.ajax({
							url: "http://ict.neit.edu/001264912/public_html/se251/bubbaLyrics/index.php?action=signUpDetails",
							method: "POST",
							data: signUp
						})
						.done(function(data){
							$.post("http://ict.neit.edu/001264912/public_html/se251/bubbaLyrics/index.php?action=signUpLog", signUp)
