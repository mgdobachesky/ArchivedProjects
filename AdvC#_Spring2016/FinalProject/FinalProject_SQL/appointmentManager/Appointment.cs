...
namespace appointmentManager
{
    ...
    public class Appointment
    {
        ...
        public string addRecord()
        {
            ...
            string strSQL = "INSERT INTO AppointmentsFinal (PersonId, Street1, Street2, City, State, Zip, StartDate, EndDate, Comments) VALUES(@PersonId, @Street1, @Street2, @City, @State, @Zip, @StartDate, @EndDate, @Comments)";
        ...
        public DataSet searchAppointments(Int32 personId)
        {
            ...
            String strSql = "SELECT AppointmentId, Street1, Street2, City, State, Zip, StartDate, EndDate, Comments FROM AppointmentsFinal WHERE PersonId = @PersonId;";
        ...
        public SqlDataReader AppointmentInformation(int appointmentId)
        {
            ...
            string sqlString = "SELECT AppointmentId, PersonId, Street1, Street2, City, State, Zip, StartDate, EndDate, Comments FROM AppointmentsFinal WHERE AppointmentId = @AppointmentId;";
        ...
        public Int32 DeleteAppointment(int appointmentId)
        {
            ...
            string sqlString = "DELETE FROM AppointmentsFinal WHERE AppointmentId = @AppointmentId;";
        ...
        public Int32 recordsSelected(int appointmentId)
        {
            ...
            //sql command used to pull data
            string sqlString = "SELECT COUNT(*) FROM AppointmentsFinal WHERE AppointmentId = @AppointmentId;";
        ...
        public Int32 updateAppointment()
        {
            ...
            string sqlString = "UPDATE AppointmentsFinal SET Street1 = @Street1, Street2 = @Street2, City = @City, State = @State, Zip = @Zip, StartDate = @StartDate, EndDate = @EndDate, Comments = @Comments WHERE AppointmentId = @AppointmentId";
