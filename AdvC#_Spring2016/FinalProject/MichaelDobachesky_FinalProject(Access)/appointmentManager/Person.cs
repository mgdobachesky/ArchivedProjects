...
namespace appointmentManager
{
    ...
    public class Person
    {
        ...
        public string addRecord()
        {
            ...
            string strSQL = "INSERT INTO People (FName, LName, Street1, Street2, City, State, Zip, Email, Phone) VALUES(@FName, @LName, @Street1, @Street2, @City, @State, @Zip, @Email, @Phone)";
            ...
            try
            {
                ...
                //add a record
                results = comm.ExecuteNonQuery().ToString() + " Person Added";
        ...
        public DataSet searchPeople(String FirstName, String LastName)
        {
            ...
            String strSql = "SELECT PersonId, FName, LName, Street1, Street2, City, State, Zip, Email, Phone FROM People WHERE 0=0";
        ...
        public OleDbDataReader PersonInformation(int personId)
        {
            ...
            string sqlString = "SELECT PersonId, FName, LName, Street1, Street2, City, State, Zip, Email, Phone FROM People WHERE PersonId = @PersonId";
        ...
        public Int32[] DeletePerson(int personId)
        {
            ...
            string sqlString = "DELETE FROM Appointments WHERE PersonId = @PersonId;";
            ...
            //delete the person
            //sql command that deletes an appointment
            sqlString = "DELETE FROM People WHERE PersonId = @PersonId;";
        ...
        public Int32[] peopleSelected(int personId)
        {
            ...
            //sql command used to pull data
            string sqlString = "SELECT COUNT(*) FROM Appointments WHERE PersonId = @PersonId;";
            ...
            //sql command used to pull data
            sqlString = "SELECT COUNT(*) FROM People WHERE PersonId = @PersonId;";
        ...
        public Int32 updatePerson()
        {
            ...
            string sqlString = "UPDATE People SET FName = @FName, LName = @LName, Street1 = @Street1, Street2 = @Street2, City = @City, State = @State, Zip = @Zip, Email = @Email, Phone = @Phone WHERE PersonId = @PersonId;";
